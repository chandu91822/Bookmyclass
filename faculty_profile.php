...
<head>
    <meta charset="UTF-8">
    <title>My Profile | BookMyClass</title>
        ...
        <main class="main-content fade-in-up glass-panel">
            ...
            <div class="profile-layout" style="display: flex; gap: 2rem; flex-wrap: wrap;">
                ...
                <div class="form-group">
                    ...
                    <small style="color: var(--text-muted); display: block; margin-top: 5px;">Contact admin to change name.</small>
                </div>
                ...
                <form method="POST">
                    ...
                    <button type="submit" name="change_password" class="btn btn-primary form-btn">Update Password</button>
                </form>
            </div>
            </div>
        </main>
